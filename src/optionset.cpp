...
void OptionSet::init ( string _program, string _desc, int _help_distance=15 )
{
...
void OptionSet::add_arg ( string arg )
{
	args.push_back ( arg );
}

void OptionSet::add_option ( string __long, string _default, string __short = "", string _type = "string", string desc = "Generic Option" ) 
{
	option buff;
...
bool OptionSet::long_type ( string buff, bool feed = true )
{
	bool __long__;
	if ( buff.substr ( 0, 2 ) == "--" )
	{
...
string OptionSet::strip ( string in )
{
	if ( in [ 1 ] == '-' )
	{
		misc::removechar ( in, '-' );
...
void OptionSet::feed ( string op_line )
{
	input_line = op_line;
...
string OptionSet::space_find ( string in )
{
	string out;
...
string OptionSet::operator () ( string op )
{
	bool is_long;
	int buff;
...
bool OptionSet::operator [] ( string op )
{
	bool is_long;
	int buff;
