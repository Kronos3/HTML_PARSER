...
void template_variable::init_name ( vector < string > __template, int _line_number, int _indent )
{
...
void template_variable::format_special ( string auto_filenames )
{
...
vector < string > template_variable::format_file ( )
{
